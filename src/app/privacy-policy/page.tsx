            ...
            <Container className="py-5 mt-4">
                <Row className="gy-5 align-items-start">
                    ...
                    <div className="entry-content mt-3" >
                        ...
                        <p>Welcome to Little England’s Farmland Property Privacy Policy. This policy outlines how we collect, use, disclose, and safeguard your personal information. By using our services, you consent to the practices described in this policy.</p>
                        ...
                        <p><strong>10. Contact Us:</strong> If you have questions, concerns, or requests related to your personal information or this Privacy Policy, please contact us at <span className="elementor-icon-list-text">+91 96887 77793, </span><span className="elementor-icon-list-text">info@littleengland.cm</span>.</p>
