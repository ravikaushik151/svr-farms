                ...
                <Row className="justify-content-center">
                    <Col lg={10} className="text-center">
                        ...
                        <p className="text-muted lh-lg mt-3" style={{ fontSize: '1.05rem' }}>
                            What's left behind: a belt of hills at around 1,000 meters, Kenilworth Fort — the only fort in India built in the style of an English castle — and land prices that haven't yet caught up to what the location can actually do.
                        </p>
                    </Col>
                </Row>
            </Container>
                    ...
                    <Row className="justify-content-center">
                        <Col lg={6} className="text-center mb-4 mb-lg-0 d-flex flex-column justify-content-center">
                            ...
                            <div className="d-flex justify-content-center gap-3 align-items-center flex-wrap">
                                <span className="fw-bold">Contact Little England:</span>
                                <a href="tel:+919688777793" className="text-decoration-none text-sanjeevani fw-bold">+91 96887 77793</a>
