                                ...
                                <div className="p-4 card-body">
                                    ...
                                    <div className="card-text text-start mt-3 blog-details">
                                        ...
                                        <div>
                                            ...
                                            <p data-start={5989} data-end={6035}><strong data-start={5643} data-end={5679}>Ready to embark on this journey?</strong>&nbsp;<a href="https://littleengland.cm/contact-us">Contact Little England Farms&nbsp;</a>for <span className="relative -mx-px my-[-0.2rem] rounded px-px py-[0.2rem] transition-colors duration-100 ease-in-out">farmland near bangalore </span>today to learn more about their offerings and schedule a site visit.</p>
                                        </div>
