                                ...
                                <div className="p-4 card-body">
                                    ...
                                    <div className="card-text text-start mt-3 blog-details">
                                        <div>
                                            ...
                                            <p data-start={3340} data-end={3406}><strong data-start={3340} data-end={3350}>Hosur:</strong> Renowned for <a href="https://littleengland.cm/mango-farm-for-sale-in-hosur">Alphonso and Banganapalli</a> mango quality.</p>
                                            ...
                                            <p data-start={1147} data-end={1205}><strong data-start={1147} data-end={1165}>Carbon credits</strong> offer a modern <a href="https://littleengland.cm/managed-farmland-near-bangalore-hassle-free-farming">passive income</a> source.</p>
