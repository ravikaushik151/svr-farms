        ...
        <div className="position-relative vh-100 d-flex align-items-center text-white text-center" style={{
            ...
            <Container className="position-relative z-1">
                <Row className="justify-content-center">
                    <Col lg={10}>
                        <h6 className="text-uppercase letter-spacing-2 mb-3 small fw-semibold text-white-50">Discover SVR Farms</h6>
                        <h1 className="display-3 fw-bold mb-4">
                            Easy Way To Own Managed<br />Farmland And Enjoy Growth
                        </h1>
                        <div className="mt-5">
